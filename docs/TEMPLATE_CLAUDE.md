...
===============================================================
TYPESCRIPT VERSION — replace everything below this line with the
Python version when using the python template
===============================================================

### Stack
- Runtime: Node.js
- Backend: Express + TypeScript
- Templates: served as static HTML or via Express
- Database: SQLite via better-sqlite3

### Key Files
- src/api/server.ts — application entry point, routes live here
- src/db/database.ts — all database logic lives here, nowhere else
- src/files/fileIO.ts — all file I/O logic lives here
...
- All DB access through src/db/database.ts — no SQL anywhere else
